import { ResolvedSwiperOptions, SwiperState } from "@/types";
  ...
  export function getSnapOffset(container: HTMLElement, options: ResolvedSwiperOptions, state: SwiperState): number {
  ...
  export function snapToNearest(container: HTMLElement, options: ResolvedSwiperOptions, state: SwiperState): void {
